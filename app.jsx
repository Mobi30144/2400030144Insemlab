...
//         <thead>
//           <tr>
//             <th style={thTdStyle} onClick={() => sortBy('f_name')}>
//               Name {getArrow('f_name')}
//             </th>
//             <th style={thTdStyle} onClick={() => sortBy('department')}>
//               Department {getArrow('department')}
//             </th>
//             <th style={thTdStyle} onClick={() => sortBy('salary')}>
...
//               onMouseLeave={(e) => Object.assign(e.currentTarget.style, getRowStyle(index))}
//             >
//               <td style={thTdStyle}>{emp.f_name}</td>
